...
press "control c" to exit the live website
"""
...
def your_python_code(input_frase):
    ...
    if nessuna_corrispondenza > 0 and titolo_o_autore_corrispondenza == 0 :
        ...
        with open(file_path, 'w') as file:
            file.write("Numero di libri trovati =  %s \n (Autore - Titolo - Numero di copie disponibili) \n\n" % (count))
...
def execute_code():
    ...
    ### return render_template('generic.html', file_content=file_content)
